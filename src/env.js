...
export const env = createEnv({
  ...
  server: {
    ...
    AUTH_TOKEN: z.string(),
    ADD_CASH_5: z.string(),
    ADD_CASH_10: z.string(),
    ADD_CASH_15: z.string(),
    ADD_CASH_25: z.string(),
    ADD_CASH_50: z.string(),
    ADD_CASH_75: z.string(),
    ADD_CASH_100: z.string(),
  ...
  runtimeEnv: {
    ...
    STRIPE_BASE_API: process.env.STRIPE_BASE_API,
    ...
    ADD_CASH_25: process.env.ADD_CASH_25,
